...
const items = [
  { icon: CheckCircle2, title: "Application accepted", desc: "Rohit accepted your application for fan installation.", time: "2h" },
  { icon: Bell, title: "New job nearby", desc: "Plumbing job posted 1 km away.", time: "5h" },
  { icon: Bell, title: "Reminder", desc: "Complete your profile to get more jobs.", time: "1d" },
];
